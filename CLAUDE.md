...
- **Unity Input System** (`com.unity.inputsystem` 1.19.0) — action maps in `Assets/InputSystem_Actions.inputactions` (Move, Look, Jump, Sprint, Crouch, Attack, Interact, Pause)
